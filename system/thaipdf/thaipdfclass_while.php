		...
		class ThaiPDF {
			...
			*******************************************************************************/
			function ThaiPDF($orientation='P',$unit='mm',$format='A4'){
				...
				if(is_string($format))	{
					...
					elseif($format=='a4') $format=array(595.28,850.89);
			...
			function SetHeader($SetTil , $SetShwP, $SetAlgn, $SetAdd,$text1){
				$this->HTitle = $SetTil;
				$this->HShowPNo = $SetShwP;
				$this->HAlign = $SetAlgn;
				$this->HAdd = $SetAdd;
				$this->TEXT_HEAD1=$text1;
			}
			...
			function Header() {
				if($this->HAdd == 1){
					...
					//$this->MultiCell(0,0,$this->TEXT_HEAD1,0,0,'C');
					$this->SetWidths(array(195));
					$this->SetAligns(array('C'));
					$this->Row_noline(array($this->TEXT_HEAD1));
			...
			*******************************************************************************/
			...
			function SetThaiFont(){
				...
				$this->AddFont('THSarabunPSK','B','thsarabunb.php');
				$this->AddFont('THSarabunPSK','I','thsarabuni.php');
				$this->AddFont('THSarabunPSK','BI','thsarabunbi.php');
			}
			//End of class
		}
